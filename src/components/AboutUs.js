        ...
        <section className="relative md:py-24 py-16" id="about">
                ...
                <div className="grid lg:grid-cols-12 md:grid-cols-2 grid-cols-1 items-center gap-[30px]">
                    ...
                    <div className="lg:col-span-7">
                        <div className="lg:ms-5">
                            <h3 className="mb-6 md:text-2xl text-xl md:leading-normal leading-normal font-semibold">I'm a Passionate Cybersecurity Specialist AboutUs.js</h3>

                            <p className="text-slate-400 max-w-xl text-[15px]">I am a passionate cybersecurity professional with a budding interest in application security. My journey in cybersecurity began with a strong interest in protecting applications from vulnerabilities and ensuring secure software development practices. I have a solid foundation in security principles and software development, and I am continuously expanding my knowledge through hands-on experience and continuous learning.</p>
            ...
            <div className="container md:mt-24 mt-16">
                <div className="grid grid-cols-1 pb-8 text-center">
                    <h3 className="mb-6 md:text-2xl text-xl md:leading-normal leading-normal font-semibold">Hobbies & Expertise AboutUs.js</h3>
